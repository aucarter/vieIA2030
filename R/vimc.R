prep_vimc_rr_data <- function(alpha) {
    ...
    rr_dt <- vimc_rr(vimc_impact, all_deaths, coverage_inputs, alpha)
...
#' @return A table with VIMC relative-risk
vimc_rr <- function(vimc_impact, all_deaths, coverage_inputs, alpha) {
